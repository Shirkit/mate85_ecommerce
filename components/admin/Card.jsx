...
export default async function Card(props) {
  ...
  return (
    <div class="max-w-lg w-full lg:max-w-full lg:flex shadow-lg">
      ...
      <div class="p-6 border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
