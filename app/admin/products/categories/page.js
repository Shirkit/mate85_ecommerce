...
export default async function AddEditCategories({ params }) {
	...
	return (
		<div className="max-w-[70%] overflow-x-auto flex flex-col justify-center mx-auto gap-4">
			<h3 className="text-2xl w-full font-bold border-b-zinc-600 border-b text-zinc-900 mt-5 pb-4">
				Categorias
			</h3>
			<EditableTable
				title="Sub-produtos"
